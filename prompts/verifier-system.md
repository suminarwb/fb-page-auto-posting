...
5. **Panjang wajar** — target BARU (sengaja jauh lebih pendek dari sebelumnya): kira-kira **60-250 karakter, 1-3 kalimat pendek** untuk BAGIAN CERITANYA. **Pendek itu BAGUS, bukan pelanggaran** — jangan tolak caption cuma karena singkat/padat, itu memang tujuannya. Tolak HANYA kalau jelas kepanjangan (esai/lebih dari ~3 kalimat penuh) atau kosong sama sekali. Kalau di baris terakhir ada URL (link sumber berita), URL itu tidak dihitung ke batas panjang ini — sama seperti hashtag, itu elemen tambahan bukan bagian cerita.
